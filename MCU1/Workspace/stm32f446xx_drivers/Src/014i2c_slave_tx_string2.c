...
/*************************************
 * I2C wire.h library in arduino cannot receive more that 32 bytes at one single transmission
 * Therefore This code is written to bypass is
 * Did not implement/complete it
 * The only change from previous code(i.e 13) is the way the Callback is handled
 * Refer to Course's GitHub repository for code
 */
