...
/*******************************************************************************************************************************************************
 * NOTE: THIS FILE IS NOT USED. USE THE OTHER FILE WITH SAME NUMBER i.e 13
 * Created this because there was a file with this name before and compiled it. The actual name is tx and not Rx
 * Therefore made a new file with the required name and number and deleted the old file
 * Since then compiler is throwing error that it is not able to find  the old file. Hence, I created a file with the same name
 ******************************************************************************************************************************************************/
#include <stdio.h>
#include <string.h>
